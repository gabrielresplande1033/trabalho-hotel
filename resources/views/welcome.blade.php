                ...
                <div class="col-lg-7">
                    <div class="contact_form_container">
                        ...
                        <form action="#" id="contact_form" class="contact_form">
                            <input type="text" id="contact_form_name" class="contact_form_name input_field" placeholder="Nome" required="required" data-error="Nome é necessário.">
                            <input type="text" id="contact_form_email" class="contact_form_email input_field" placeholder="E-mail" required="required" data-error="Email é necessário.">
                            <input type="text" id="contact_form_subject" class="contact_form_subject input_field" placeholder="Assunto" required="required" data-error="Assunto é necessário.">
                            <textarea id="contact_form_message" class="text_field contact_form_message" name="message" rows="4" placeholder="Message" required="required" data-error="Por favor, escreva sua mensagem."></textarea>
